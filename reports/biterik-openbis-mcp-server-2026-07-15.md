...
_Updated 2026-07-15T05:40:46Z (UTC) · machine-readable: [VITALS.json](VITALS.json) · full history: [history.ndjson](history.ndjson) · daily snapshots: [snapshots/](snapshots/)_
...
**Health: 15/100** (heuristic² — traffic trend 8, activity 19, community 26, release adoption 10)
...
**Conversion funnel (30 d):** 11 unique visitors → 31 unique cloners → 0 stars gained → 0 downloads gained
...
[reports/biterik-openbis-mcp-server-2026-07-15.md](reports/biterik-openbis-mcp-server-2026-07-15.md)
