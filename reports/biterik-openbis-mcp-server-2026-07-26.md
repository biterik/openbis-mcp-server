...
_Updated 2026-07-26T06:13:45Z (UTC) · machine-readable: [VITALS.json](VITALS.json) · full history: [history.ndjson](history.ndjson) · daily snapshots: [snapshots/](snapshots/)_
...
**Health: 24/100** (heuristic² — traffic trend 33, activity 15, community 26, release adoption 10)
...
**Conversion funnel (30 d):** 11 unique visitors → 53 unique cloners → 0 stars gained → 0 downloads gained
...
[reports/biterik-openbis-mcp-server-2026-07-26.md](reports/biterik-openbis-mcp-server-2026-07-26.md)
