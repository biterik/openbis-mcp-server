...
_Updated 2026-07-11T05:48:21Z (UTC) · machine-readable: [VITALS.json](VITALS.json) · full history: [history.ndjson](history.ndjson) · daily snapshots: [snapshots/](snapshots/)_
...
**Health: 52/100** (heuristic² — traffic trend 100, activity 19, community 26, release adoption 10)
...
**Conversion funnel (30 d):** 10 unique visitors → 24 unique cloners → 0 stars gained → 0 downloads gained
...
|---|---:|---:|
| `/biterik/openbis-mcp-server` | 5 | 3 |
...
2 commits · 1 PRs opened / 1 merged · 0 issues opened / 0 closed · 3 contributors total
...
[reports/biterik-openbis-mcp-server-2026-07-11.md](reports/biterik-openbis-mcp-server-2026-07-11.md)
